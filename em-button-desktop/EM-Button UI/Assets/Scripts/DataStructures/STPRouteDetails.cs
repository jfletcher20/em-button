...
public class RouteManagement {
    public struct STPRouteDetails {
        ...
        public bool validate(STPCommand command) {
            bool validateDictionary = false;
            if (command.data != null && data != null) {
                if (command.data.Keys == data.Keys) {
    ...
    private static void _initSavedRoutes() {
        ...
        Dictionary<string, string> db_post_put_or_save_data = new Dictionary<string, string>();
        db_post_put_or_save_data.Add("id", "");
        db_post_put_or_save_data.Add("electromagnet", "");
        db_post_put_or_save_data.Add("hall_sensor", "");
        db_post_put_or_save_data.Add("electromagnet_power", "");
        db_post_put_or_save_data.Add("actions", "");
